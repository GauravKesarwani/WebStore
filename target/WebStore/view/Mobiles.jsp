...
<link href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" rel="stylesheet" type="text/css"></link>
	<link href="http://cdn.datatables.net/plug-ins/a5734b29083/integration/jqueryui/dataTables.jqueryui.css" rel="stylesheet" type="text/css"></link>
...
<body>
	<div class="container" id="main">
		...
		<br>
		<br>
		<table id="mobilesCatalog" class="display row-border hover">
			<thead>
				<tr>
		...
		<div>
			<input type="hidden" id="hiddencategory" value="Mobiles" />
