...
$('#laptopsCatalog tbody').on('click', 'input', function(event) {
	var nTr = $(this).parents('tr')[0];
	var oTable = $("#laptopsCatalog").dataTable();
...
$('#laptopsCatalog tbody').on('click', 'tr', function(event) {
	// alert($(this).id);
